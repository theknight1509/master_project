\setlength{\subfigwidth}{0.45\textwidth} %Use subfigwidth for the first two figures
...
\renewcommand\MCEdelmaxdir[1]{../thesis/results/MCExperiment_revised_2_delmax/#1}
...
\begin{frame}
\frametitle{Results - \textbf{Yields} without postprocessing}
...
\begin{frame}
  \frametitle{Results - \textbf{Yields} with postprocessing}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=\linewidth]{\curdir{compare_rate_analytical_models.png}}
  \end{figure}
\end{frame}

\begin{frame}
  \frametitle{Results - Uncertainties of \textbf{Yields+IMFslope}}
  %add plots of Os-187, Re-187, Os-187/Re-187 for MCExperiment w/IMFslope
  \begin{figure}
    \centering
    \includegraphics[width=\subfigwidth]{\MCEdelmaxdir{combined_plot_div_decayed_meteordata.png}}
    \hfill \raisebox{10ex}{$\rightarrow$} \hfill
    \includegraphics[width=\subfigwidth]{\MCEimfslopedir{combined_plot_div_decayed_meteordata.png}}
    %% \centering
    %% \begin{subfigure}{\subfigwidth}
...
\begin{frame}
  \frametitle{Results - Uncertianties of \textbf{Yields+IMFslope+NSM}}
  \begin{figure}[h]
    \centering
    \includegraphics[width=\subfigwidth]{\MCEdelmaxdir{combined_plot_div_decayed_meteordata.png}}
    \hfill \raisebox{10ex}{$\rightarrow$} \hfill
    \includegraphics[width=\subfigwidth]{\MCEnumnsmdir{combined_plot_div_decayed_meteordata.png}}
  %% \centering
  %% \begin{subfigure}{\subfigwidth}
