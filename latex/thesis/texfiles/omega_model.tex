...
%% The parameter space was sampled by running 300 parameter combinations where each parameter was varied within their gaussian probability distribution.
%% Then a set of 700 models were calculated with all parameters sampled randomly from their gaussian probability distribution.
%% A final set of 300 parameter combinations were also calculated with varying final stellar and gas mass.
