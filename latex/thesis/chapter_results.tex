...
In \mycite{rosswog17} an estimate at the amount of nuetron star mergers required in our neighbourhood is estimated (see \mycitetwo{rosswog17}{fig.6}).
...
\section{Consider events of binary neutron star mergers} \label{sec:nsm-events}
