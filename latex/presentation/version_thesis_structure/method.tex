...
\end{frame}
\begin{frame}
  \frametitle{Mass content}
  \begin{figure}
    \centering
    \begin{subfigure}{\subfigwidth}
      \centering
      \includegraphics[width=\linewidth]{\curdir{set_mass_3_plot_stellar_mass.png}}
    \end{subfigure}
    \begin{subfigure}{\subfigwidth}
      \centering
      \includegraphics[width=\linewidth]{\curdir{set_mass_3_plot_total_mass.png}}
    \end{subfigure}
  \end{figure}
\end{frame}
\begin{frame}
  \frametitle{Stellar parameters}
  \begin{figure}
    \centering
    \begin{subfigure}{\subfigwidth}
      \centering
...
\end{frame}
\begin{frame}
  \frametitle{Neutron star mergers}
  \begin{figure}
    \centering
    \begin{subfigure}{\subfigwidth}
      \centering
      \includegraphics[width=\linewidth]{\curdir{set_nsm_plot_final_rates.png}}
    \end{subfigure}
    \begin{subfigure}{\subfigwidth}
      \centering
...
\begin{frame}
  ...
  \begin{table}[h]
    \centering
    \input{\thesisdir{texfiles/arnould_table_modified}}
    \caption{Values and uncertainties of r-process nuclei near \re{187} from \mycite{arnould07}}
