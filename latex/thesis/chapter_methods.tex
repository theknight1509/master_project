...
A galaxy's mass consist of gas and stars (not counting dark matter from section \ref{sec:cosmology}), and in a one-zone model there is only gas and stars inside the box and gas outside the box (see figure \ref{tikz:galaxy-iobox}).
