...
class experiment(omega):
    def __init__(self, input_isotope='Re-187', input_factor=1.0,
        ...
        ### initialize omega ###
        bestfit_special_timesteps = input_timesteps
        if dt > 0: #deactive special timestepping
            bestfit_special_timesteps = 0
            bestfit_dt = dt
        else:
            bestfit_dt = 0
