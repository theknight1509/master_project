...
timesteps = n
loa_tmerge_vals, save_name = read_param("t_merge") #get values from 'parameter_space.txt'
bestfit_mgal = 2.0e+10
loa_omega_inst = [omega(special_timesteps=timesteps, t_merge=tmerge,
                        ...
                        mgal=bestfit_mgal)
                  for tmerge in loa_tmerge_vals] #omega-instances with new parameter
loa_omega_names = ["$t_{merge}$%1.2e"%t for t in loa_tmerge_vals]

#visualize masses and sfr with 'visualize'
title = "Vary merger time of NSM"
