\begin{table}
  \begin{tabular}{|c|c|c|c|c|}
    ...
    \hline
  \end{tabular}
  \caption{\label{tab:guedes10-baryonic-mass}
    ...
    Time is calculated from redshift using Ned Wright's cosmology calculator(February 12th 2018)\comment{reference to cosmology calculator article here} with the cosmological parameters, $H_0=73[km s^{-1} Mpc^{-1}]$, $\Omega_M=0.24$, and $\Omega_\Lambda=1-\Omega_M=0.76$ for a flat universe as stated in \comment{reference guedes10-article}.}
\end{table}
