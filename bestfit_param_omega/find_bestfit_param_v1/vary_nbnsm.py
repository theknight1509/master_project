...
loa_omega_names = ["$M_{NSM}\in$%s"%nbnsm for nbnsm in loa_nbnsm_vals]
...
plot_obj.add_yields("Eu", index_yaxis=0, time="sum")
plot_obj.add_yields("Re-187", index_yaxis=1, time="sum")
